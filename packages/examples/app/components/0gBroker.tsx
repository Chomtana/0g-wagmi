...
import { use0gAddFunds, use0gBalance } from '0g-wagmi'
...
export function ZGBrokerComponent() {
  ...
  const { balance, isLoading: isLoadingBalance, refetch } = use0gBalance({
    enabled: isConnected,
        ...
        {isLoadingBalance ? (
          ...
          <div className="space-y-2 bg-gray-50 p-4 rounded">
            ...
            <div className="flex justify-between">
              ...
              <span>{(Number(balance.availableBalance) / 1e18).toFixed(6)} OG</span>
            </div>
          </div>
        ) : (
